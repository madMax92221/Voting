...
uint constant private DURATION = 360 seconds;
uint public startAt;
uint public endAt;
...
if(partycount[uint(Parties.A)] > partycount[uint(Parties.B)] && partycount[uint(Parties.A)] > partycount[uint(Parties.C)]) {
winner = Parties.A;
 } 
 else if(partycount[uint(Parties.B)] > partycount[uint(Parties.A)] && partycount[uint(Parties.B)] > partycount [uint(Parties.C)]) {
     winner = Parties.B;
    }
else {
     winner = Parties.C;
